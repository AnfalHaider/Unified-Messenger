...
**Current release:** v4.39.4 (P2-A: unsaved-contact phone from contact-store; message previews harvested from the scrolled sidebar DOM, since bodies are encrypted at rest)
