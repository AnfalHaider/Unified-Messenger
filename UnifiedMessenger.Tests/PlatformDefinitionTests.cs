...
public class PlatformDefinitionTests
{
    ...
    public void GoogleBusiness_IsRegisteredAsEmbeddableChannel()
    {
        ...
        // Land on the Business Profile Manager reviews page (the oversight surface), not the bare root
        // (which redirects single-location managers into a raw Google Search results page).
        Assert.Equal("https://business.google.com/reviews", google.DefaultUrl);
    }
