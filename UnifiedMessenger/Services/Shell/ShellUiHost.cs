...
public interface IShellUiHost
{
    ...
    /// <summary>Show/configure the web navigation toolbar for an embedded/custom-URL tab, or hide it (null,
    /// or a WhatsApp-family instance the app drives itself).</summary>
    void ShowWebNavBar(Models.MessengerInstance? instance);
}
