...
`docs/ui-ux-research-and-recommendations.md` · `docs/multi-instance-research-and-limitations.md` · `docs/validation/{completion-criteria,v2-reaudit-checklist,wave11-checklist,remaining-issues-log}.md` · `.cursor/adversarial-swarm/STAGE{1,4,6}-*.md` (historical evidence). Living reference: `docs/architecture/*`, `docs/design-system/*`, `README.md`, `.crawl4ai/occ-research/**`.
