...
| Swarm logs | `.cursor/adversarial-swarm/**` (Stage1 agents, **Stage4 sabotage results**, exit handshake) | **Honest perf/risk catalogue** |
...
In-repo: `docs/architecture/system-map.md`, `docs/validation/remaining-issues-log.md`, `.cursor/adversarial-swarm/STAGE4-sabotage-results.md`, `docs/ui-ux-research-and-recommendations.md`.
