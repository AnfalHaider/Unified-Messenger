...
**Date:** 2026-08-27 · **Baseline:** v4.99.50 · **Source of truth:** [MASTER-PLAN.md](MASTER-PLAN.md)
...
> - **Critical build fix:** the documented publish command wrote to `bin\Release` but the installer packages `bin\x64\Release` → every install Jun 19–20 shipped a stale binary. Fixed; AGENTS.md updated; **always `-p:Platform=x64` + verify installed `FileVersion`.**
