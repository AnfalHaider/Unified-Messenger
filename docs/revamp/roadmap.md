...
location filter, all of Phase 5 (the assistant, 30 of 30 on the real model) 6.1 (Google sign-in), 6.2 (the Firestore rules, tested and live) and 6.3 (workspaces and the shared setup), each installed on the owner's PC. **Next step: 6.4** (invite and remove members), in the release plan below, unless an owner decision
...
| 6 · Cloud and membership | 6.1 sign-in, 6.2 rules (live) and 6.3 workspaces and setup sync done. Members, owner and suspended screens are still sample. Firebase project `unified-messenger-5549a`. |
