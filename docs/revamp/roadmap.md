...
location filter, all of Phase 5 (the assistant, 30 of 30 on the real model) 6.1 (Google sign-in) and 6.2 (the Firestore rules, tested), each installed on the owner's PC. **Next step: 6.3** (workspaces and setup sync), in the release plan below, unless an owner decision
...
| 6 · Cloud and membership | 6.1 sign-in and 6.2 rules done, rules live. Members, owner and suspended screens are still sample. Firebase project `unified-messenger-5549a`. |
