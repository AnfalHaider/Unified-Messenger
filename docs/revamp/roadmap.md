...
location filter, all of Phase 5 (the assistant, 30 of 30 on the real model), and Phase 6 so far: 6.1 Google sign-in, 6.2 the Firestore rules (tested and live), 6.3 workspaces and the shared setup, 6.4 members, and 6.5 suspension and the owner console, each installed on the owner's PC. **Next step: 6.6** (the homepage and privacy pages Google's consent screen needs), in the release plan below, unless an owner decision
...
| 6 · Cloud and membership | 6.1 sign-in, 6.2 rules (live), 6.3 setup sync, 6.4 members, 6.5 suspension done. 6.6 pages left. Members, owner and suspended screens are still sample. Firebase project `unified-messenger-5549a`. |
