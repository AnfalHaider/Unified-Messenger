...
| 9 | Unit tests green; UiSmoke green | **Pass** (unit) / **CI** (smoke) | ~1800 unit tests (v4.99.47; was 534 at v4.2.0). UI smoke does not gate releases and reports exit 5 when the runner has no interactive desktop — see `.github/workflows/build.yml` |
